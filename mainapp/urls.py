...
urlpatterns = [
    ...
    path('ajax/', product_list, name='ajax'),
    path('category/<int:pk>/', product_list, name='category'),
    path('category/<int:pk>/ajax/', cache_page(3600)(product_list_ajax), name='ajax'),
    path('category/<int:pk>/page/<int:page>/', product_list, name='page'),
    path('category/<int:pk>/page/<int:page>/ajax/', cache_page(3600)(product_list_ajax), name='ajax'),
