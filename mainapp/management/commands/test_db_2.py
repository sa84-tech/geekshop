...
class Command(BaseCommand):
    def handle(self, *args, **options):
        ...
        action_1__price = When(action_1__condition, then=F('product__price') * F('qtty') * action_1__discount)
        action_2__price = When(action_2__condition, then=F('product__price') * F('qtty') * action_2__discount)
        action_expired__price = When(action_expired__condition, then=F('product__price') * F('qtty') *
